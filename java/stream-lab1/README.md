...
## ***ACTION*** - EDIT `~/kafka-training/stream-lab1/bin/start-consumer-console-output.sh`, follow instructions in file, then run the script.
...
If you can, keep this window open so you can see it as the demo runs.
...
#### Output from running run-word-count-demo.sh
```
$ cd ~/kafka-training/stream-lab1/bin
